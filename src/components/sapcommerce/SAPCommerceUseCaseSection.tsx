const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="85" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Global Creators</text>
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">SAP Data</text>
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Enterprise ROI</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Multi-Market</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Compliance</text>

    <circle cx="315" cy="220" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Scale</text>
  </svg>
);
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Track global influencer campaigns across multiple SAP storefronts and international markets'
  },
  {
    icon: TrendsIcon,
    text: 'Measure creator ROI with enterprise-grade attribution models and customer journey mapping'
  },
  {
    icon: ShareIcon,
    text: 'Scale influencer operations with centralized reporting across business units and regions'
  }
];

export default function SAPCommerceUseCaseSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          Connect Social Commerce to SAP Analytics
        </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with SAP Commerce Cloud to power influencer marketing for global enterprises. Track creator performance across markets, currencies, and customer segments with the security, compliance, and scalability your business demands.
          </p>
        </div>
