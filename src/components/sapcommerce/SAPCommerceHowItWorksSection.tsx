const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">API</text>
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <text x="37" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="middle">SAP Commerce</text>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Cloud</text>
...
const steps = [
  ...
  },
  {
    ...
    description: 'Storyclash automatically matches creator traffic to SAP customer journeys, orders, and revenue across all markets.'
  },
  {
    number: '03',
    title: 'Scale globally with confidence',
    description: 'Unified reporting across countries, currencies, and business units - enterprise visibility into creator ROI worldwide.'
  }
];

export default function SAPCommerceHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Track Creator Revenue Across Global Markets
        </h2>
