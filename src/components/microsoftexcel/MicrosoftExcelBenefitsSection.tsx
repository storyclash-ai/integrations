...
const benefits = [
  {
    ...
    description: 'Export creator data to Excel for offline analysis - work without internet, maintain local archives, and control your data.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
    title: 'Advanced Financial Modeling',
    description: 'Use Excel formulas, pivot tables, and macros for sophisticated ROI calculations and budget forecasting.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
    title: 'Custom Reporting Templates',
    description: 'Build reusable Excel templates for influencer reports - apply your branding, formatting, and calculation logic.'
  }
];

export default function MicrosoftExcelBenefitsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Professional Analysis Meets Creator Intelligence
          </h2>
          <p className="max-w-2xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Export influencer data to the world's most powerful spreadsheet tool
          </p>
        </div>
