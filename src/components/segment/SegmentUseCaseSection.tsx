const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="85" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Creator Events</text>
    <circle cx="60" cy="115" r="3" fill="#52BD94" />
    <circle cx="85" cy="115" r="3" fill="#52BD94" />
    <circle cx="110" cy="115" r="3" fill="#52BD94" />

    <rect x="145" y="100" width="110" height="80" rx="8" stroke="#52BD94" strokeWidth="2.5" fill="rgba(82, 189, 148, 0.06)" />
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#52BD94" textAnchor="middle">Segment CDP</text>
    <rect x="165" y="150" width="70" height="8" rx="4" fill="#52BD94" opacity="0.3" />
    <rect x="165" y="162" width="55" height="8" rx="4" fill="#52BD94" opacity="0.5" />

    <rect x="260" y="60" width="110" height="80" rx="8" stroke="#E5EAEC" strokeWidth="2" fill="white" />
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">300+ Tools</text>
    <path d="M280 115 L290 125 L300 110 L310 120 L320 105 L330 115 L340 108" stroke="#52BD94" strokeWidth="2" fill="none" />

    <path d="M145 100 L200 80" stroke="#52BD94" strokeWidth="2" strokeDasharray="4 4">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="0.5s" repeatCount="indefinite" />
    </path>
    <path d="M255 140 L315 140" stroke="#52BD94" strokeWidth="2" strokeDasharray="4 4">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="0.5s" repeatCount="indefinite" />
    </path>

    <circle cx="85" cy="220" r="35" stroke="#52BD94" strokeWidth="2" fill="rgba(82, 189, 148, 0.05)" />
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#52BD94" textAnchor="middle">Analytics</text>

    <circle cx="200" cy="260" r="35" stroke="#52BD94" strokeWidth="2" fill="rgba(82, 189, 148, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#52BD94" textAnchor="middle">CRM</text>

    <circle cx="315" cy="220" r="35" stroke="#52BD94" strokeWidth="2" fill="rgba(82, 189, 148, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#52BD94" textAnchor="middle">Email</text>
  </svg>
);
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            {useCases.map((useCase, index) => {
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-300 group-hover:scale-110" style={{ color: '#52BD94' }}>
                    <Icon />
                  </div>
