const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    <rect x="40" y="40" width="120" height="80" rx="8" stroke="#189EFF" strokeWidth="2" fill="rgba(24, 158, 255, 0.05)" />
    <text x="100" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Storyclash</text>

    <rect x="240" y="40" width="120" height="80" rx="8" stroke="#189EFF" strokeWidth="2" fill="rgba(24, 158, 255, 0.05)" />
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Shopware</text>

    <path d="M165 80 L235 80" stroke="#189EFF" strokeWidth="2" strokeDasharray="4 4">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="0.5s" repeatCount="indefinite" />
    </path>
    <path d="M230 75 L240 80 L230 85" fill="#189EFF" />

    <circle cx="100" cy="180" r="30" stroke="#189EFF" strokeWidth="2" fill="rgba(24, 158, 255, 0.08)" />
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#189EFF" textAnchor="middle">Orders</text>

    <circle cx="200" cy="240" r="30" stroke="#189EFF" strokeWidth="2" fill="rgba(24, 158, 255, 0.08)" />
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#189EFF" textAnchor="middle">Metrics</text>

    <circle cx="300" cy="180" r="30" stroke="#189EFF" strokeWidth="2" fill="rgba(24, 158, 255, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#189EFF" textAnchor="middle">Growth</text>
...
export default function ShopwareWhyStoryclashSection() {
  return (
    <section className="py-20 px-6 bg-white border-t border-b" style={{ borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl lg:text-5xl font-black mb-16 text-center tracking-tight" style={{ color: '#189EFF' }}>
          Why Storyclash for Shopware?
        </h2>
