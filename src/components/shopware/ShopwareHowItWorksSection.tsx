const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#189EFF" textAnchor="middle">Connector</text>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center font-black text-lg text-white" style={{ backgroundColor: '#189EFF' }}>
                    {step.number}
                  </div>
                  <div>
