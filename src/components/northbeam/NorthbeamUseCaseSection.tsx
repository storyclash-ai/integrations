const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Northbeam</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Track</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Measure</text>
...
const useCases = [
  {
    ...
    text: 'Track creator touchpoints across the customer journey using machine learning attribution models'
  },
  {
    icon: MLIcon,
    text: 'Measure true influencer impact with incrementality tests comparing exposed vs control audiences'
  },
  {
    icon: TestingIcon,
    text: 'Run scientific hold-out tests to prove actual revenue lift from creator campaigns'
  }
];

export default function NorthbeamUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Connect Influencer Data to Northbeam
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Stream creator performance data to Northbeam for ML-powered attribution and incrementality testing. Track influencer touchpoints across the customer journey with multi-touch attribution models. Measure true creator impact with hold-out tests comparing exposed versus control audiences.
          </p>
        </div>
