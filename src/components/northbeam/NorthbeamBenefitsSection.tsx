...
const benefits = [
  {
    ...
    description: 'Measure true creator impact - Northbeam\'s incrementality testing reveals actual revenue lift from influencer campaigns versus baseline.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
    title: 'Multi-Touch Attribution',
    description: 'Track creator touchpoints precisely - see how influencers contribute throughout customer journeys with machine learning attribution models.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
...
export default function NorthbeamBenefitsSection() {
  return (
    <section className="py-24 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          Attribute Creator Revenue with Multi-Touch Attribution
        </h2>
          <p className="max-w-2xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Accurate attribution and incrementality testing for influencer campaigns
          </p>
        </div>
