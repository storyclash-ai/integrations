const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Northbeam</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Attribution</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Revenue</text>
...
const benefits = [
  {
    ...
    description: 'Bring test-and-learn rigor to influencer marketing. Run incrementality tests with exposed vs control audiences to prove actual revenue lift from creator campaigns with statistical confidence.'
  },
  {
    icon: MLModelIcon,
    title: 'ML-Powered Attribution',
    description: 'Leverage Northbeam\'s machine learning models to track creator touchpoints across complex customer journeys. Understand multi-touch attribution from influencers across all channels and devices.'
  },
  {
    icon: IncrementalityIcon,
    title: 'True ROI Measurement',
    description: 'Move beyond last-click attribution to understand true creator impact. Measure incrementality with hold-out tests and compare influencer effectiveness against paid ads and other marketing channels.'
  }
];

export default function NorthbeamWhyStoryclashSection() {
  return (
