const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Module</text>
    ...
    <g transform="translate(285, 58)" opacity="0">
      ...
      <path d="M12.5 0 L25 12.5 L12.5 25 L0 12.5 Z" fill="#DF0067"/>
      <circle cx="12.5" cy="12.5" r="4" fill="white"/>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">PrestaShop</text>
...
const steps = [
  {
    number: '01',
    title: 'Install PrestaShop module',
    description: 'Download and install the Storyclash module from the PrestaShop Addons marketplace or via FTP.'
  },
  {
    number: '02',
...
export default function PrestaShopHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          How the PrestaShop Integration Works
        </h2>
