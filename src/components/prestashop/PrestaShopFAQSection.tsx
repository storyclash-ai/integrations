...
const faqs = [
  {
    question: 'How do I install the PrestaShop module?',
    answer: 'Download the Storyclash module from the PrestaShop Addons marketplace or install via FTP. Configuration takes about 10 minutes with our step-by-step guide.'
  },
  {
