const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <path d="M0 0L4 4L0 8" fill="#96BF48" />
      <path d="M4 0L8 4L4 8" fill="#96BF48" opacity="0.7" />
      <rect x="10" y="2" width="6" height="4" fill="#96BF48" opacity="0.5" />

      <text x="18" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="start">Shopify</text>
    </g>
...
export default function ShopifyHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Attribute Sales to Individual Influencers and Campaigns
        </h2>
