const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <text x="37" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="middle">Shopify</text>
    </g>
...
const steps = [
  {
    ...
    description: 'Activate the Shopify connector in Storyclash and connect your store.'
  },
  {
    number: '02',
