...
const benefits = [
  {
    ...
    description: 'Import creator metrics and campaign performance data directly into Shopify via Storyclash API or connector.'
  },
  {
    icon: ChartIcon,
...
export default function ShopifyBenefitsSection() {
  return (
