const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="85" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Soziale Daten</text>
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">KPIs</text>
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Erkenntnisse</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">ROI</text>
    ...
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Teilen</text>
  </svg>
);
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Kombinieren Sie Influencer-ROI mit Ad-Spend und Sales-KPIs'
  },
  {
    icon: TrendsIcon,
    text: 'Erkennen Sie Trends, Top-Performer und verschwendete Ausgaben'
  },
  {
    icon: ShareIcon,
    text: 'Teilen Sie Dashboards unternehmensweit mit Echtzeit-Updates'
  }
];

export default function ShopifyUseCaseSectionDE() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Automatisieren Sie Rabattcodes und Product-Seeding-Workflows
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrieren Sie Storyclash mit Shopify, um Influencer-Daten mit jedem Marketing-KPI zu verbinden, das zählt – Umsatz, Traffic, CRM. Mit einer einheitlichen Ansicht können Sie endlich die Auswirkungen von Creator-Kampagnen auf Ihren gesamten Marketing-Mix nachweisen.
          </p>
        </div>
