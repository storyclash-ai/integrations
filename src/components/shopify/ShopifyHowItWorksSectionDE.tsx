const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="90" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Verbinden</text>

    <rect x="150" y="140" width="100" height="70" rx="8" stroke="#19B776" strokeWidth="2.5" fill="rgba(25, 183, 118, 0.06)" />
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Datensync</text>
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Automatisiert</text>

    <rect x="260" y="40" width="100" height="70" rx="8" stroke="#19B776" strokeWidth="2.5" fill="rgba(25, 183, 118, 0.06)" />

    <text x="310" y="72" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Shopify</text>
...
const steps = [
  {
    number: '01',
    title: 'Verbinden Sie Ihr Storyclash-Konto',
    description: 'Sichere API-Authentifizierung in Minuten.'
  },
  {
    number: '02',
    title: 'Synchronisieren Sie Ihre Creator-Kampagnendaten',
    description: 'Alle Metriken (Umsatz, Konversionen, EMV, Engagement) fließen automatisch in Shopify-Datensätze.'
  },
  {
    number: '03',
    title: 'Erstellen Sie Dashboards & messen Sie ROI',
    description: 'Visualisieren Sie die Kampagnenperformance, vergleichen Sie Creator und überwachen Sie den ROI über die Zeit.'
  }
];

export default function ShopifyHowItWorksSectionDE() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Attributieren Sie Umsätze einzelnen Influencern und Kampagnen zu
        </h2>
