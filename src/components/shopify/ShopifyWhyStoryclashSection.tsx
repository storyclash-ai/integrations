...
const benefits = [
  {
    ...
    description: 'No manual exports or spreadsheets. Storyclash delivers ready-to-use influencer and campaign data directly into your Shopify environment - clean, standardized, and automated.'
  },
  {
    icon: EnterpriseIcon,
  ...
  },
  {
    ...
    description: 'Combine influencer engagement and sales performance inside Shopify to visualize what truly drives business impact - with full transparency and zero guesswork.'
  }
];
  ...
  return (
    <section className="py-20 px-6 bg-white border-t border-b" style={{ borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl lg:text-5xl font-black mb-16 text-center tracking-tight" style={{ color: '#19B776' }}>
          Why Storyclash for Shopify?
        </h2>

        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-gradient-to-br from-green-50/50 to-transparent rounded-2xl p-8 lg:p-12">
