...
const benefits = [
  {
    ...
    description: 'Import creator metrics and campaign performance data directly into WooCommerce via the Storyclash REST API using your API key.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
  ...
  },
  {
    ...
    description: 'Build automated WooCommerce reports for management and stakeholders - no manual data wrangling.'
  }
];

export default function WooCommerceBenefitsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Sync Creator Campaign Data to Your WooCommerce Store
          </h2>
