const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="90" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Monitor</text>

    <rect x="150" y="140" width="100" height="70" rx="8" stroke="#19B776" strokeWidth="2.5" fill="rgba(25, 183, 118, 0.06)" />
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">API Sync</text>
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Real-time</text>

    <rect x="260" y="40" width="100" height="70" rx="8" stroke="#19B776" strokeWidth="2.5" fill="rgba(25, 183, 118, 0.06)" />

    <g transform="translate(280, 55)" opacity="0">
      <animate attributeName="opacity" from="0" to="1" dur="0.8s" begin="0.5s" fill="freeze" />
      <path d="M10 5 L10 25 M20 0 L20 30 M30 10 L30 20" stroke="#EE672F" strokeWidth="2" strokeLinecap="round"/>
      <circle cx="10" cy="15" r="1.5" fill="#EE672F"/>
      <circle cx="20" cy="15" r="1.5" fill="#EE672F"/>
      <circle cx="30" cy="15" r="1.5" fill="#EE672F"/>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Magento</text>
...
const steps = [
  ...
  {
    number: '03',
    title: 'Measure ROI across stores',
    description: 'Analyze which creators drive the most revenue, best-selling products, and highest customer lifetime value.'
  }
];

export default function MagentoHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Track Creator-Driven Revenue Across Product Categories
        </h2>
