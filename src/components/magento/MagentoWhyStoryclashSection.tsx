const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Magento</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Sync</text>
...
const benefits = [
  {
    ...
    description: 'Handle multi-store, multi-language, and multi-currency Magento deployments with ease. Storyclash scales with your enterprise architecture without compromising performance or data accuracy.'
  },
  {
    icon: EnterpriseIcon,
  ...
  },
  {
    ...
    description: 'Go beyond basic metrics with sophisticated attribution models, customer lifetime value tracking, and cohort analysis. Understand the true long-term value of every creator partnership.'
  }
];

export default function MagentoWhyStoryclashSection() {
  return (
