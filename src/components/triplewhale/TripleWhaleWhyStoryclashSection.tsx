const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Triple Whale</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Revenue</text>
...
const benefits = [
  {
    ...
    title: 'Pixel-Accurate Attribution',
    description: 'Capture influencer touchpoints with Triple Whale pixel tracking and attribute revenue, orders, and CAC directly to creator campaigns.'
  },
  {
    icon: UnifiedIcon,
    title: 'Unified Commerce Analytics',
    description: 'View creator metrics alongside Shopify revenue, ad spend, and email data in one dashboard - eliminate data silos and inform budget decisions.'
  },
  {
    icon: RealtimeIcon,
    title: 'Real-Time Performance Insights',
    description: 'Monitor influencer campaigns in real-time against paid channels, see which creators drive the highest ROI, and optimize spend instantly.'
  }
];

export default function TripleWhaleWhyStoryclashSection() {
  return (
    <section className="py-20 px-6 border-t border-b" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="mb-16 text-center" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#19B776', fontFamily: 'Roboto, sans-serif' }}>
          Why Storyclash for Triple Whale?
        </h2>
