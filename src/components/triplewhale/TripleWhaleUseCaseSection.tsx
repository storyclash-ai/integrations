...
const useCases = [
  {
    icon: PixelIcon,
    text: 'Use Triple Whale pixel tracking to capture influencer touchpoints and attribute revenue with pixel-accurate attribution'
  },
  {
    icon: UnifyIcon,
    text: 'View all creator metrics in one dashboard - combine influencer performance with Shopify revenue and ad spend data'
  },
  {
    icon: CompareIcon,
    text: 'Compare creator ROI against paid ads, email marketing, and organic channels to optimize social commerce budgets'
  }
];

export default function TripleWhaleUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Optimize Social Commerce Spend for DTC Brands
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Connect Storyclash to Triple Whale for unified creator analytics alongside Shopify revenue and ad spend. Track influencer-driven orders, revenue, and customer acquisition cost in Triple Whale's real-time dashboard.
          </p>
        </div>
