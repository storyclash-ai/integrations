const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Analytics</text>
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <text x="37" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="middle">Triple Whale</text>
    </g>
