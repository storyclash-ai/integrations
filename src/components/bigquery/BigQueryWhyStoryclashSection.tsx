const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">BigQuery</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">SQL</text>
...
export default function BigQueryWhyStoryclashSection() {
  return (
