const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#4285F4" textAnchor="middle">SQL Queries</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#4285F4" textAnchor="middle">Analytics</text>

    <circle cx="200" cy="260" r="35" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#4285F4" textAnchor="middle">ML Models</text>

    <circle cx="315" cy="220" r="35" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#4285F4" textAnchor="middle">Reports</text>
  </svg>
);
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Run SQL queries on creator performance across campaigns and platforms'
  },
  {
    icon: TrendsIcon,
    text: 'Join influencer data with Google Analytics, Ads, and CRM datasets'
  },
  {
    icon: ShareIcon,
    text: 'Build machine learning models for predictive campaign insights'
  }
];

export default function BigQueryUseCaseSection() {
  return (
    <section className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight" style={{ color: '#233C42' }}>
            From Creator Data to Enterprise Analytics
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Integrate Storyclash with BigQuery to unlock SQL-powered analytics on influencer data.
            Run complex queries, join datasets, and build predictive models at petabyte scale.
          </p>
        </div>
