...
const benefits = [
  {
    icon: ConnectIcon,
    color: '#19B776',
    title: 'Connect Storyclash to Power BI effortlessly',
    description: 'Import creator metrics and campaign performance data directly into Power BI via Storyclash API or connector.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
  ...
  },
  {
    ...
    description: 'Build automated Power BI reports for management and stakeholders - no manual data wrangling.'
  }
];
