...
const benefits = [
  ...
  },
  {
    ...
    description: 'Present influencer ROI to leadership - create polished dashboards with custom KPIs and professional visualizations.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
    title: 'Custom Metrics',
    description: 'Define your own creator KPIs - combine Storyclash data with other sources for comprehensive influencer analytics.'
  }
];

export default function KlipfolioBenefitsSection() {
  return (
    <section className="py-24 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          Build Real-Time Creator Performance Dashboards
        </h2>
          <p className="max-w-2xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Build professional influencer dashboards with real-time data updates and custom KPIs
          </p>
        </div>
