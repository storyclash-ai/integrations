const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Export</text>
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <text x="37" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="middle">Supermetrics</text>
    </g>
...
const steps = [
  {
    number: '01',
    title: 'Connect Storyclash API source',
    description: 'Add Storyclash as a data source in Supermetrics - authenticate once to access all creator metrics through our API.'
  },
  {
    number: '02',
    title: 'Sync with Supermetrics',
    description: 'Storyclash data flows automatically into Supermetrics, enabling seamless integration with your marketing reporting stack.'
  },
  {
    number: '03',
    ...
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Automate Influencer Data Transfers to Reporting Tools
        </h2>
