const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Automated</text>
    <text x="200" y="153" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Export</text>
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Reporting</text>
    <text x="315" y="110" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Platform</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Multi-Channel</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Unified Data</text>

    <circle cx="315" cy="220" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Analytics</text>
  </svg>
);
...
const useCases = [
  ...
  {
    icon: UnifyIcon,
    text: 'Create unified marketing dashboards combining creator performance with other channel metrics'
  }
];

export default function SupermetricsUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Unify Social Media Metrics with Marketing Data
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Connect Storyclash to Supermetrics for automated influencer data transfers across your marketing stack. Schedule regular exports to Google Sheets for reporting, push creator metrics to data warehouses for analysis, or feed influencer performance into BI dashboards alongside other marketing channels.
          </p>
        </div>
