...
const benefits = [
  {
    ...
    description: 'Schedule creator data exports automatically - Supermetrics moves influencer metrics to your destination without manual work.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
    title: 'Multi-Destination Support',
    description: 'Send creator data anywhere - connect influencer metrics to Google Sheets, Excel, BigQuery, Snowflake, or any BI tool.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
    title: 'Unified Marketing Data',
    description: 'Combine creator metrics with other channels - blend influencer performance with paid ads, SEO, and social data in one view.'
  }
];

export default function SupermetricsBenefitsSection() {
  return (
    <section className="py-24 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          Export Creator Performance Data via Supermetrics
        </h2>
          <p className="max-w-2xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Automate influencer data transfers to spreadsheets, warehouses, and BI platforms
          </p>
        </div>
