...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Track creator-driven revenue and customer acquisition using code-based attribution.'
  },
  {
    icon: TrendsIcon,
    text: 'Identify which creators generate the highest lifetime value and repeat purchases.'
  },
  {
    icon: ShareIcon,
    text: 'Compare creator ROI using attributed revenue and costs across your marketing mix.'
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with Klar to unify creator insights with your commerce analytics. Track sales impact, acquisition cost and lifetime value with code-based attribution.
          </p>
        </div>
