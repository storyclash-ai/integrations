...
const benefits = [
  {
    ...
    description: 'Integrate Storyclash creator data with Klar\'s commerce analytics for unified reporting across your ecommerce operations.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Secure Data Integration',
    description: 'Enterprise-grade security with secure API authentication, role-based access control and GDPR compliance.'
  },
  {
    icon: ROIIcon,
    title: 'Advanced Attribution & Analytics',
    description: 'Go beyond basic metrics by combining Storyclash creator signals with Klar\'s code-based attribution, lifetime value insights and cohort analysis.'
  }
];
