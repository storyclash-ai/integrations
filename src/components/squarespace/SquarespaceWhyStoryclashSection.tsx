const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Squarespace</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Design</text>
...
const benefits = [
  ...
  {
    icon: ROIIcon,
    title: 'Grow Your Creative Business',
    description: 'Focus on what you do best - creating and selling. Let Storyclash handle the complexity of influencer attribution so you can confidently invest in creator partnerships that drive real revenue.'
  }
];

export default function SquarespaceWhyStoryclashSection() {
  return (
