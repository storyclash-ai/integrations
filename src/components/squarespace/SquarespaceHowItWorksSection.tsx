const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Track</text>
    ...
    <g transform="translate(285, 58)" opacity="0">
      ...
      <circle cx="20" cy="5" r="3" fill="#000000" opacity="0.6"/>
      <circle cx="5" cy="20" r="3" fill="#000000" opacity="0.6"/>
      <circle cx="20" cy="20" r="3" fill="#000000"/>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Squarespace</text>
...
export default function SquarespaceHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Track Creator-Driven Sales and Revenue
          </h2>
