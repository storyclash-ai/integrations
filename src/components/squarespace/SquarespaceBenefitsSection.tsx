...
const benefits = [
  ...
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
    title: 'Creator-to-Sale Attribution',
    description: 'Track which influencers drive purchases in your Squarespace store with precise revenue attribution and product insights.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
    title: 'Automated Performance Reports',
    description: 'Real-time sync of order data with creator campaigns - elegant reporting that matches your Squarespace aesthetic.'
  }
];

export default function SquarespaceBenefitsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Beautiful Commerce Meets Influencer Intelligence
          </h2>
