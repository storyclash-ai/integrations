const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Looker Studio</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">Visual</text>

    <circle cx="300" cy="180" r="30" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">Insights</text>
...
const benefits = [
  {
    icon: SimplifyIcon,
    title: 'Effortless Data Visualization',
    description: 'No manual exports or complex ETL processes. Storyclash delivers clean influencer data directly to Looker Studio - ready for instant visualization with drag-and-drop simplicity.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Enterprise-Quality Analytics',
    description: 'Access standardized, reliable creator metrics designed for professional BI teams. Storyclash provides consistent KPIs that integrate seamlessly with your existing Looker Studio workflows.'
  },
  {
    icon: ROIIcon,
    title: 'Turn Data into Decisions',
    description: 'Build interactive dashboards that reveal creator performance patterns and campaign insights. Combine influencer data with other sources for complete marketing attribution visibility.'
  }
];
