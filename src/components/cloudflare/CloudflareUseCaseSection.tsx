...
export default function CloudflareUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Integrate Storyclash with Cloudflare to connect influencer data with every marketing KPI that matters - sales, traffic, CRM.
