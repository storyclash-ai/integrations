const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="310" y="72" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Klaviyo</text>
...
const steps = [
  {
    number: '01',
    title: 'Connect Klaviyo API',
    description: 'Authenticate to sync creator engagement data into Klaviyo as custom profile properties and events for segmentation.'
  },
  {
    number: '02',
    title: 'Build creator segments',
    description: 'Create Klaviyo segments based on influencer interactions - who clicked creator links, viewed content, or converted from campaigns.'
  },
  {
    number: '03',
    title: 'Personalize campaigns',
    description: 'Use creator data in email flows and campaigns. Include influencer UGC, track attribution, and measure creator-driven revenue.'
  }
];

export default function KlaviyoHowItWorksSection() {
  return (
