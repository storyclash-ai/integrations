const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Klaviyo</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Segments</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Email</text>
...
const benefits = [
  {
    ...
    description: 'Storyclash syncs creator engagement to Klaviyo profile properties. Build segments based on influencer interactions for hyper-targeted email campaigns.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Personalized Content',
    description: 'Include creator UGC and recommendations in email flows. Storyclash provides influencer assets optimized for email personalization and conversion.'
  },
  {
    icon: ROIIcon,
    title: 'Revenue Attribution',
    description: 'Track which creators drive email conversions using Klaviyo revenue reporting. Measure influencer ROI alongside other email marketing metrics.'
  }
];

export default function KlaviyoWhyStoryclashSection() {
  return (
