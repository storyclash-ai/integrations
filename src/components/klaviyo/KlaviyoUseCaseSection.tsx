const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Klaviyo</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Segments</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Flows</text>

    <circle cx="315" cy="220" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Revenue</text>
  </svg>
);
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Build segments based on creator engagement for targeted campaigns'
  },
  {
    icon: TrendsIcon,
    text: 'Include influencer UGC in automated email flows and campaigns'
  },
  {
    icon: ShareIcon,
    text: 'Track which creators drive email conversions and revenue'
  }
];

export default function KlaviyoUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            From Creator Engagement to Email Conversions
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with Klaviyo to segment audiences by creator engagement.
            Personalize email campaigns with influencer content for higher conversion rates.
          </p>
        </div>
