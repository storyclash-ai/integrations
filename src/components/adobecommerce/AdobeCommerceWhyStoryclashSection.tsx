const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Adobe Commerce</text>
...
const benefits = [
  {
    ...
    description: 'No manual exports or spreadsheets. Adobe Commerce sends orders and revenue data directly to Storyclash via the connector - clean, automated, and enterprise-ready.'
  },
  {
    icon: EnterpriseIcon,
  ...
  },
  {
    ...
    description: 'Combine influencer engagement and revenue data across regions and product categories to identify true business drivers - with complete transparency and multi-touch attribution.'
  }
];

export default function AdobeCommerceWhyStoryclashSection() {
  return (
    <section className="py-20 px-6 border-t border-b" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="mb-16 text-center" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#19B776', fontFamily: 'Roboto, sans-serif' }}>
          Why Storyclash for Adobe Commerce?
        </h2>
