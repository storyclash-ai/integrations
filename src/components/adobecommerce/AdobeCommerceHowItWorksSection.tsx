const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <path d="M0 0L4 4L0 8" fill="#FF0000" />
      <path d="M4 0L8 4L4 8" fill="#FF0000" opacity="0.7" />
      <rect x="10" y="2" width="6" height="4" fill="#FF0000" opacity="0.5" />

      <text x="18" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="start">Adobe Commerce</text>
    </g>
