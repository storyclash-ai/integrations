...
const benefits = [
  {
    ...
    description: 'Import creator metrics and campaign performance data directly into Adobe Commerce via REST API or middleware integration for real-time insights.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
