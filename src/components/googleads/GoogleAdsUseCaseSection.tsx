...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Track creator conversions and ROAS in Google Ads dashboards'
  },
  {
    icon: TrendsIcon,
    text: 'Build lookalike audiences from high-performing influencer followers'
  },
  {
    icon: ShareIcon,
    text: 'Optimize ad budgets based on creator campaign performance data'
  }
];

export default function GoogleAdsUseCaseSection() {
  return (
    <section className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight" style={{ color: '#233C42' }}>
            From Creator Content to Paid Ad Performance
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Integrate Storyclash with Google Ads to optimize influencer campaigns with precision.
            Track conversions, build high-intent audiences, and maximize paid social ROI.
          </p>
        </div>
