const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    <rect x="40" y="40" width="120" height="80" rx="8" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.05)" />
    <text x="100" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Storyclash</text>
    <rect x="240" y="40" width="120" height="80" rx="8" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.05)" />
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Google Ads</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">Creators</text>
    <circle cx="200" cy="240" r="30" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.08)" />
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">ROAS</text>
    <circle cx="300" cy="180" r="30" stroke="#4285F4" strokeWidth="2" fill="rgba(66, 133, 244, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#4285F4" textAnchor="middle">Optimize</text>
...
const benefits = [
  {
    icon: SimplifyIcon,
    title: 'Performance-Driven Attribution',
    description: 'Storyclash connects creator content to Google Ads conversion data automatically. See exactly which influencers drive purchases, signups, and revenue through paid campaigns.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Audience Intelligence',
    description: 'Export high-performing creator audience segments to Google Ads for lookalike targeting. Reach users most likely to convert based on influencer engagement patterns.'
  },
  {
    icon: ROIIcon,
    title: 'Budget Optimization',
    description: 'Identify top-performing creator campaigns in real-time. Shift ad spend to winning influencer content and eliminate wasteful spending on underperforming campaigns.'
  }
];

export default function GoogleAdsWhyStoryclashSection() {
  return (
