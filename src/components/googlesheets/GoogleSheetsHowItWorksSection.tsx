const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Export</text>
    ...
    <g transform="translate(285, 58)" opacity="0">
      ...
      <rect width="30" height="22" rx="1" fill="#0F9D58"/>
      <path d="M5 5 L25 5 M5 9 L25 9 M5 13 L25 13 M5 17 L25 17" stroke="white" strokeWidth="1"/>
      <path d="M15 0 L15 22" stroke="white" strokeWidth="1"/>
    </g>
    <text x="310" y="95" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Google Sheets</text>
...
const steps = [
  {
    ...
    description: 'Authorize Storyclash to export data to your Google Sheets account - secure OAuth connection in seconds.'
  },
  {
    number: '02',
  ...
  },
  {
    ...
    description: 'Data updates automatically in Sheets - build custom reports, share with teams, and analyze your way.'
  }
];

export default function GoogleSheetsHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Automate Influencer Campaign Reporting
        </h2>
