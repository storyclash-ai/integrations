const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Sheets Sync</text>
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Custom Reports</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Export</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Analyze</text>

    <circle cx="315" cy="220" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Share</text>
  </svg>
);

const ROIIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="8" width="20" height="16" rx="1" stroke="currentColor" strokeWidth="2"/>
    <path d="M8 12 L20 12 M8 16 L20 16 M8 20 L20 20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M14 8 L14 24" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Export influencer performance data for custom analysis, pivot tables, and formula-based reporting'
  },
  {
    icon: TrendsIcon,
    text: 'Share real-time creator metrics with stakeholders who prefer working in Google Sheets'
  },
  {
    icon: ShareIcon,
    text: 'Build custom dashboards and reports combining influencer data with other business metrics'
  }
];

export default function GoogleSheetsUseCaseSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          Track Social Media Metrics in Spreadsheets
        </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with Google Sheets to give your team flexible access to influencer data. Export creator metrics automatically and build custom reports using the spreadsheet tool everyone already knows.
          </p>
        </div>
