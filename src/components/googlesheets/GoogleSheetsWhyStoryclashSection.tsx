const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Sheets</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Export</text>

    <circle cx="200" cy="240" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Analyze</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Share</text>
...
const benefits = [
  {
    icon: SimplifyIcon,
    title: 'Work in the Tool You Know',
    description: 'No need to learn new reporting software. Export influencer data to Google Sheets and analyze it using the formulas, pivot tables, and charts your team already understands. Instant adoption, zero training required.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Unlimited Stakeholder Access',
    description: 'Share creator performance data with executives, marketing teams, and external agencies without adding platform seats. Everyone can view, analyze, and collaborate on influencer metrics in Google Sheets.'
  },
  {
    icon: ROIIcon,
    title: 'Custom Analysis Without Constraints',
    description: 'Build the exact reports you need using Google Sheets formulas and functions. Combine influencer data with other business metrics, create custom calculations, and design dashboards that match your specific workflow.'
  }
];

export default function GoogleSheetsWhyStoryclashSection() {
  return (
    <section className="py-20 px-6 border-t border-b" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="mb-16 text-center" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#19B776', fontFamily: 'Roboto, sans-serif' }}>
          Why Storyclash for Google Sheets?
        </h2>
