const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(275, 55)" opacity="0">
      ...
      <rect x="0" y="4" width="3" height="10" rx="0.5" fill="#F2C811" />
      <rect x="4" y="2" width="3" height="12" rx="0.5" fill="#F2C811" opacity="0.8" />
      <rect x="8" y="0" width="3" height="14" rx="0.5" fill="#F2C811" opacity="0.6" />

      <text x="18" y="11" fontSize="11" fontWeight="700" fill="#19B776" textAnchor="start">Power BI</text>
    </g>
