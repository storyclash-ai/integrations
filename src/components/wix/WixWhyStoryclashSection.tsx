...
const benefits = [
  {
    ...
    description: 'Built for business owners, not developers. Connect your Wix store and start tracking creator sales in minutes without any coding, APIs, or technical complexity.'
  },
  {
    icon: EnterpriseIcon,
