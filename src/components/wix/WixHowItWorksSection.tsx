const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(285, 60)" opacity="0">
      <animate attributeName="opacity" from="0" to="1" dur="0.8s" begin="0.5s" fill="freeze" />
      <path d="M5 5 L10 15 L15 8 L20 15 L25 5" stroke="#0C6EFC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="15" cy="3" r="1" fill="#0C6EFC"/>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Wix Store</text>
...
const steps = [
  {
    ...
    description: 'Simple one-click integration - no API keys or technical knowledge needed.'
  },
  {
    number: '02',
