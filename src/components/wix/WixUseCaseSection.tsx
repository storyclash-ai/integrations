const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Store Data</text>
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">ROI Metrics</text>
    ...
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Traffic</text>
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Track influencer-driven Wix store sales and product performance'
  },
  {
    icon: TrendsIcon,
    text: 'Identify top-performing creators and optimize your marketing budget'
  },
  {
    icon: ShareIcon,
    text: 'Scale your small business with data-driven influencer partnerships'
  }
];

export default function WixUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            From Social Posts to Store Sales
          </h2>
