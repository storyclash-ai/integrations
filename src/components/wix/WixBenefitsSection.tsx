...
const benefits = [
  {
    ...
    description: 'Connect Storyclash to your Wix eCommerce store in minutes - no coding or technical setup required.'
  },
  {
    icon: ChartIcon,
    color: '#D1215D',
    title: 'Creator Sales Attribution',
    description: 'Track which influencers drive actual purchases in your Wix store with precise revenue attribution.'
  },
  {
    icon: AutomateIcon,
    color: '#F49D3B',
    title: 'Automated Performance Sync',
    description: 'Real-time sync of order data and creator metrics - measure ROI without manual spreadsheet work.'
  }
];

export default function WixBenefitsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="max-w-2xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Built for small businesses and growing brands
          </p>
        </div>
