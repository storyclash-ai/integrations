const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Klar</text>
...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Track influencer-driven revenue and customer acquisition by source'
  },
  {
    icon: TrendsIcon,
    text: 'Identify which creators drive highest customer lifetime value and repeat purchases'
  },
  {
    icon: ShareIcon,
    text: 'Compare influencer ROI against paid ads, email, and other marketing channels'
  }
];

export default function KlarUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Connect Influencer Data to E-Commerce Analytics
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with Klar to unify influencer metrics with commerce analytics. Track creator impact on revenue, customer acquisition cost, and lifetime value with multi-touch attribution modeling.
          </p>
        </div>
