const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Klar</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Track</text>
    ...
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Optimize</text>
...
const benefits = [
  {
    icon: SimplifyIcon,
    title: 'Built for E-Commerce Analytics',
    description: 'Seamlessly integrate influencer data with Klar\'s commerce analytics. Handle multi-store, multi-channel deployments with ease while maintaining data accuracy and performance.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Secure Data Integration',
    description: 'Enterprise-grade security with OAuth authentication, role-based access control, and GDPR compliance. Your customer data stays protected with encrypted transmission and secure storage.'
  },
  {
    icon: ROIIcon,
    title: 'Advanced Attribution & Analytics',
    description: 'Go beyond basic metrics with multi-touch attribution, customer lifetime value tracking, and cohort analysis. Understand the true long-term value of every creator partnership.'
  }
];

export default function KlarWhyStoryclashSection() {
  return (
    <section className="py-20 px-6 border-t border-b" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5EAEC' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="mb-16 text-center" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#19B776', fontFamily: 'Roboto, sans-serif' }}>
          Connect Influencer Data to Klar Analytics
        </h2>
