        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-50/50 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="relative">
                  <div className="w-12 h-12 flex items-center justify-center mb-6 text-gray-700 group-hover:text-[#29B5E8] transition-colors duration-300">
                    <Icon />
                  </div>
