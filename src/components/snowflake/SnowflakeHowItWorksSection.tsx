const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <rect x="150" y="140" width="100" height="70" rx="8" stroke="#29B5E8" strokeWidth="2.5" fill="rgba(41, 181, 232, 0.06)" />
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#29B5E8" textAnchor="middle">ETL Pipeline</text>
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Data Flow</text>

    <rect x="260" y="40" width="100" height="70" rx="8" stroke="#29B5E8" strokeWidth="2.5" fill="rgba(41, 181, 232, 0.06)" />
    <text x="310" y="72" fontSize="13" fontWeight="700" fill="#29B5E8" textAnchor="middle">Snowflake</text>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Warehouse</text>

    <path d="M145 75 L195 145" stroke="#19B776" strokeWidth="2" markerEnd="url(#arrowhead1)" />
    <path d="M205 145 L265 80" stroke="#29B5E8" strokeWidth="2" markerEnd="url(#arrowhead2)" />

    <circle cx="90" cy="240" r="5" fill="#19B776">
      <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" />
    </circle>
    <circle cx="200" cy="240" r="5" fill="#29B5E8">
      <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" begin="0.7s" repeatCount="indefinite" />
    </circle>
    <circle cx="310" cy="240" r="5" fill="#29B5E8">
    ...
    <defs>
      ...
      <marker id="arrowhead2" markerWidth="10" markerHeight="10" refX="9" refY="3" orient="auto">
        <polygon points="0 0, 10 3, 0 6" fill="#29B5E8" />
      </marker>
    </defs>
  </svg>
);
...
export default function SnowflakeHowItWorksSection() {
  return (
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center font-black text-lg text-white" style={{ backgroundColor: '#29B5E8' }}>
                    {step.number}
                  </div>
                  <div>
