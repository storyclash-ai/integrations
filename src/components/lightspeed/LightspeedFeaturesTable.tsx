...
const features = [
  ...
  },
  {
    ...
    description: 'See which products move fastest when promoted by specific creators - optimize stock accordingly.'
  }
];

export default function LightspeedFeaturesTable() {
  return (
