const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <g transform="translate(285, 58)" opacity="0">
      ...
      <path d="M5 5 L15 0 L15 10 L25 10 L15 20 L15 10 L5 10 Z" fill="#00B2A9"/>
      <circle cx="15" cy="0" r="2" fill="#FFD700"/>
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Lightspeed</text>
...
const steps = [
  ...
  {
    number: '03',
    title: 'Measure total impact',
    description: 'See unified reporting across retail and online channels - understand true creator ROI for your omnichannel business.'
  }
];

export default function LightspeedHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Track Influencer Sales Across Online and Retail
          </h2>
