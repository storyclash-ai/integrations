const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Glue API</text>
    ...
    <g transform="translate(280, 58)" opacity="0">
      <animate attributeName="opacity" from="0" to="1" dur="0.8s" begin="0.5s" fill="freeze" />
      <path d="M5 0 L15 5 L25 0 M5 10 L15 5 L25 10" stroke="#E20074" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="15" cy="5" r="1.5" fill="#E20074"/>
    </g>
    <text x="310" y="95" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Spryker</text>
    ...
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          How the Spryker Integration Works
        </h2>
