const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Spryker</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Flexible</text>

    <circle cx="200" cy="240" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Modular</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Custom</text>
...
const benefits = [
  {
    icon: SimplifyIcon,
    title: 'Built for Composable Commerce',
    description: 'Spryker is modular by design, and so is Storyclash. Our integration adapts to your custom data structures, business logic, and commerce experiences - not the other way around. True flexibility for modern commerce.'
  },
  {
    icon: EnterpriseIcon,
    title: 'B2B & B2C in One Platform',
    description: 'Track influencer impact across both B2B marketplaces and B2C storefronts with unified attribution. Perfect for brands running complex, multi-tenant Spryker implementations with diverse customer types.'
  },
  {
    icon: ROIIcon,
    title: 'Scale Without Rebuilding',
    description: 'Add new markets, storefronts, and attribution models without reintegration. Composable architecture means you can evolve your influencer strategy as your Spryker commerce grows - no technical debt.'
  }
];
