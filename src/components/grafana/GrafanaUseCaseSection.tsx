const DataPipelineIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="135" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Real-time</text>
    <text x="200" y="152" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Analytics</text>
    <rect x="165" y="160" width="70" height="8" rx="4" fill="#19B776" opacity="0.3" />

    <rect x="260" y="60" width="110" height="80" rx="8" stroke="#E5EAEC" strokeWidth="2" fill="white" />
    <text x="315" y="95" fontSize="12" fontWeight="600" fill="#233C42" textAnchor="middle">Grafana</text>
    ...
    <text x="85" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Monitor</text>

    <circle cx="200" cy="260" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="200" y="265" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Alert</text>

    <circle cx="315" cy="220" r="35" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.05)" />
    <text x="315" y="225" fontSize="11" fontWeight="600" fill="#19B776" textAnchor="middle">Optimize</text>
  </svg>
);
...
const AlertIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 6V13C2 20.7 12 26 12 26S22 20.7 22 13V6L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
const useCases = [
  {
    icon: MonitoringIcon,
    text: 'Monitor real-time engagement and performance metrics across influencer campaigns'
  },
  {
    icon: TrendsIcon,
    text: 'Build time-series dashboards showing campaign performance trends and audience growth patterns'
  },
  {
    icon: AlertIcon,
    text: 'Set custom alerts for engagement anomalies and performance drops with instant notifications'
  }
];

export default function GrafanaUseCaseSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Connect Influencer Data to Grafana
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Stream creator performance data to Grafana dashboards in real-time. Track engagement, reach, and conversions with time-series visualizations. Set threshold-based alerts for campaign anomalies and correlate influencer metrics with website traffic and conversions.
          </p>
        </div>
