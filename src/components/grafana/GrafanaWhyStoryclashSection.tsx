const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Grafana</text>
    ...
    <text x="100" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Monitor</text>

    <circle cx="200" cy="240" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Alert</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Visualize</text>
...
const benefits = [
  {
    ...
    title: 'Observability-Grade Monitoring',
    description: 'Stream creator performance metrics in real-time to Grafana with millisecond precision. Build multi-layer dashboards tracking engagement, reach, conversion rates, and audience growth patterns across campaigns.'
  },
  {
    icon: AlertingIcon,
    title: 'Intelligent Alerting',
    description: 'Set threshold-based alerts for campaign anomalies - detect engagement drops, unusual audience patterns, or performance shifts instantly. Route alerts to Slack, PagerDuty, or email with rich context about what triggered them.'
  },
  {
    icon: InsightIcon,
    title: 'Correlation Analysis',
    description: 'Correlate influencer metrics with business outcomes using Grafana\'s powerful query engine. Understand how creator campaigns drive website traffic, conversions, and customer acquisition in real-time.'
  }
];

export default function GrafanaWhyStoryclashSection() {
  return (
