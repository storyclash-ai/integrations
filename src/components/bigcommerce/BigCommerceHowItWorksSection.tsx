const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="172" fontSize="13" fontWeight="700" fill="#19B776" textAnchor="middle">Attribution</text>
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">Match</text>
    ...
    <g transform="translate(280, 55)" opacity="0">
      ...
      <rect x="0" y="0" width="60" height="40" rx="4" fill="#003E52" opacity="0.1" />
      <path d="M10 15 L20 15 L20 10 L30 20 L20 30 L20 25 L10 25 Z" fill="#003E52" opacity="0.6" />
    </g>
    <text x="310" y="88" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">BigCommerce</text>
...
const steps = [
  {
    ...
    description: 'Secure OAuth integration in minutes - no developer needed.'
  },
  {
    number: '02',
...
export default function BigCommerceHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          How the BigCommerce Integration Works
        </h2>
