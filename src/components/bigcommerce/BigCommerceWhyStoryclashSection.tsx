const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">BigCommerce</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Match</text>

    <circle cx="300" cy="180" r="30" stroke="#19B776" strokeWidth="2" fill="rgba(25, 183, 118, 0.08)" />
    <text x="300" y="185" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">Convert</text>
...
const benefits = [
  {
    ...
    description: 'No technical setup required. Connect your BigCommerce store to Storyclash in minutes and start tracking creator-driven sales immediately with automated data syncing.'
  },
  {
    icon: EnterpriseIcon,
    title: 'Complete Attribution Accuracy',
    description: 'Track every influencer touchpoint from social media post to final purchase. Get precise attribution data showing which creators drive revenue, not just engagement.'
  },
  {
    icon: ROIIcon,
    title: 'Maximize Influencer ROI',
    description: 'Make data-driven decisions on creator partnerships by seeing real sales impact. Identify high-performing influencers and optimize your marketing budget with confidence.'
  }
];

export default function BigCommerceWhyStoryclashSection() {
  return (
