const DataFlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="300" y="85" fontSize="14" fontWeight="600" fill="#233C42" textAnchor="middle">Matomo</text>
    ...
    <text x="200" y="245" fontSize="12" fontWeight="500" fill="#19B776" textAnchor="middle">UTM Tags</text>
...
const benefits = [
  {
    icon: UTMTagIcon,
    title: 'Automatic UTM Tagging',
    description: 'Storyclash automatically adds UTM parameters to all creator links, ensuring every campaign is tracked in Matomo with proper source attribution.'
  },
  {
    icon: OwnershipIcon,
    title: 'Complete Data Ownership',
    description: 'Self-host Matomo on your infrastructure for complete control over creator analytics data. No dependency on third-party cloud providers or data sharing.'
  },
  {
    icon: ComplianceIcon,
    title: 'GDPR & Privacy Compliant',
    description: 'Run cookieless, privacy-respecting analytics that comply with GDPR, CCPA, and other regional regulations while tracking influencer effectiveness.'
  }
];
