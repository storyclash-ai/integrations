const FlowIllustration = () => (
  <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    <text x="200" y="188" fontSize="11" fontWeight="500" fill="#233C42" textAnchor="middle">UTM Tags</text>
...
const steps = [
  {
    number: '01',
    title: 'Connect Matomo instance',
    description: 'Link your self-hosted or cloud Matomo installation - authenticate via API token for secure data sync.'
  },
  {
    number: '02',
    title: 'Tag creator campaigns',
    description: 'Add UTM parameters to creator links - Storyclash automatically tracks and attributes traffic in Matomo.'
  },
  {
    number: '03',
    title: 'Analyze performance',
    description: 'View creator-driven metrics in Matomo - see which influencers drive traffic, conversions, and revenue.'
  }
];

export default function MatomoHowItWorksSection() {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: '#FAFAFA' }}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-16" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
          Measure Influencer Campaign Performance in Matomo
        </h2>
